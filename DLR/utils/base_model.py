...
from DLR.utils import lr_scheduler as lr_scheduler
...
class BaseModel(nn.Module):
    ...
    def validation(self, dataloader, current_iter, tb_logger, save_img=False):
        ...
        if self.opt['dist']:
            ...
            # self.loop_validation(dataloader, current_iter, tb_logger, save_img)
    ...
    def load_network(self, net, load_path, strict=True, param_key='params'):
        ...
        load_net = {k: v for k, v in load_net.items() if 'total_ops' not in k and 'total_params' not in k}
